...
/**
 * This is the extension manager of the Sapyupgradeinfoext extension.
 */
public class SapyupgradeinfoextManager extends GeneratedSapyupgradeinfoextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapyupgradeinfoextManager.class.getName());
	 ...
	 */
	public static SapyupgradeinfoextManager getInstance()
	{
		return (SapyupgradeinfoextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapyupgradeinfoextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapyupgradeinfoextManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapyupgradeinfoextManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapyupgradeinfoextManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapyupgradeinfoextManager called, current tenant: " + getTenant().getTenantID());
		}
	}
