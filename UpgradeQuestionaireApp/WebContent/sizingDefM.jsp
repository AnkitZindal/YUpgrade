        		...
        		<tr>
	        		...
	        		<td>
	        			<ul>
							...
							<li>Upgrade-compliant Hybris version </li>
	        		...
	        		<td><a href="#" onclick="document.getElementById('CalculateEffortDetails').submit()">100-200 days</a></td>
	        		<input type="hidden" id="totalEffortApp" name="totalEffortApp" value="180">
        		</tr>
